...
class SearchingDigits
{
  static Set <int> searchingDigits(String line){
    List<String> listWord = line.split(", "); //разбиваем строку на слова без пробела и запятой
    List <String> dictionaryVal = ['zero','one','two','three','four', 'five', 'six', 'seven', 'eight','nine'];
    Set <int> numInt = {};
